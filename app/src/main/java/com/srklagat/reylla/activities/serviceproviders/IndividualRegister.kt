...
class IndividualRegister : BaseActivity() {
    ...
    private fun registerUser() {
        ...
        if (validateForm(
            ...
            FirebaseAuth.getInstance()
                .createUserWithEmailAndPassword(individualEmail, individualPassword)
                    ...
                    OnCompleteListener<AuthResult> { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            val individualProvider = IndividualProviders(
                                firebaseUser.uid,1, individualProfileImage, individualFirstName,
                            ...
                            FirestoreClass().registerIndividualProvider(
    ...
    private fun validateForm(
        IndividualFirstName: String, IndividualLastName: String,
        IndividualDOB: String, IndividualEddress: String, IndividualPhoneNum: String,
        IndividualEmail: String, IndividualGender: String, IndividaulPassword: String
    ): Boolean {
        return when {
