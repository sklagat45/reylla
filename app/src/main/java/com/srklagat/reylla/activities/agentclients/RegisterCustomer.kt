...
import com.srklagat.reylla.model.Customer
import com.srklagat.reylla.utils.Constants
import com.srklagat.reylla.utils.GetAddressFromLatLng
...
class RegisterCustomer : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        et_customer_address.setOnClickListener {
            pickLocation()
        }
    ...
    private fun selectImage() {
        if (ContextCompat.checkSelfPermission(
            ...
            Constants.showImageChooser(this@RegisterCustomer)
        } else {
...
//                        ----------------------------------------------------
                        ...
                        GlideLoader(this@RegisterCustomer).loadUserPicture(
                            mSelectedImageFileUri!!,
                            iv_profile_customer_image
                        )
//                        -------------------------------------------------------
                ...
                et_customer_address.setText(place.address)
...
//        FirestoreClass().uploadImageToCloudStorage(this@CompanyRegister,mSelectedImageFileUri,imageType)
        ...
        val customerProfileImage: String = mLogoImageURL
    ...
    private fun validateForm(
        customerFName: String, customerLName: String, customerDOB: String,
        customerAddress: String, customerPhoneNumber: String, customerEmail: String, customerGender: String,
        customerPassword: String
    ): Boolean {
        return when {
            TextUtils.isEmpty(customerFName) or TextUtils.isEmpty(customerLName) or
                    TextUtils.isEmpty(customerDOB) -> {
                showErrorSnackBar("Please enter all details.")
                false
            }
            TextUtils.isEmpty(customerAddress) -> {
                showErrorSnackBar("Please select your address.")
                false
            }

            TextUtils.isEmpty(customerPhoneNumber) -> {
            ...
            TextUtils.isEmpty(customerGender) -> {
    ...
    fun customerRegisteredSuccess() {
        ...
        startActivity(Intent(this@RegisterCustomer, ClieantHomeActivity::class.java))
        //        /**
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            // START
            val addressTask =
                GetAddressFromLatLng(this@RegisterCustomer, mLatitude, mLongitude)

            addressTask.setAddressListener(object :
                GetAddressFromLatLng.AddressListener {
                override fun onAddressFound(address: String?) {
                    Log.e("Address ::", "" + address)
                    et_customer_address.setText(address) // Address is set to the edittext
                }
