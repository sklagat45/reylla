...
import com.srklagat.reylla.model.Service
import kotlinx.android.synthetic.main.activity_add_hair_service.*
import java.io.IOException

/**
 * Add Service screen of the app.
 */
class AddHairServiceActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_hair_service)
...
//                        iv_place_image.setImageURI(mSelectedImageFileUri)
    ...
    private fun validateServiceDetails(): Boolean {
        return when {
            ...
            TextUtils.isEmpty(et_hair_style_name.text.toString().trim { it <= ' ' }) -> {
                showErrorSnackBar("Enter the style name")
                false
            }

            TextUtils.isEmpty(et_hair_service_duration.text.toString().trim { it <= ' ' }) -> {
                showErrorSnackBar("Enter styling Duration")
                false
            }

            TextUtils.isEmpty(et_hair_style_cost.text.toString().trim { it <= ' ' }) -> {
...
//        hideProgressDialog()
        ...
        Toast.makeText(
            this@AddHairServiceActivity, "data uploaded successfully",
            Toast.LENGTH_SHORT
        ).show()
