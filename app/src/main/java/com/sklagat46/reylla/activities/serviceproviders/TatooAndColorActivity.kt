...
class TatooAndColorActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab_add_tattoo_color.setOnClickListener {
            ...
            startActivityForResult(
                addTattooColorServiceIntent,
                TatooAndColorActivity.ADD_SERVICE_ACTIVITY_REQUEST_CODE
            )
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == TatooAndColorActivity.ADD_SERVICE_ACTIVITY_REQUEST_CODE) {
