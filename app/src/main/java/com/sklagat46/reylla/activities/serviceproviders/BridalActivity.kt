...
class BridalActivity : AppCompatActivity() {
...
//            startActivity(Intent(this@HairCareActivity, AddHairServiceActivity::class.java))
            ...
            startActivityForResult(
                addBridalServiceIntent,
                BridalActivity.ADD_SERVICE_ACTIVITY_REQUEST_CODE
            )
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == BridalActivity.ADD_SERVICE_ACTIVITY_REQUEST_CODE) {
